...
const request_body = '__REQUEST_BODY__';
...
export default function (data) {
  runRequest(endpoint, method, request_body, data.infra_mode, data.be_mode);
}

function runRequest(endpoint, method, request_body, infra_mode, be_mode) {
  let params = {
    headers: {
  ...
  if (method.toUpperCase() === 'GET') {
    ...
    response = http.post(endpoint, request_body);
  }
