...
BASE_URL="https://api.antrein7.cloud/${be_mode}/dashboard"
...
clear_projects() {
  ...
  curl -X DELETE "https://api.antrein7.cloud/${be_mode}/dashboard/project/clear" -H "Authorization: Bearer $TOKEN" -H "Content-Type: application/json"
